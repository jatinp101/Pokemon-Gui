...
/**
 * Growlithe Pokemon Object Class.
...
public class Growlithe extends Pokemon implements FireType {
   ...
   static final int BASE_STAMINA_POWER = 146;
	   ...
	   */
   public Growlithe() {
      super("Growlithe", "Growlithe", 58, FIRE_COLOR, 0.7, 19.0, 
   ...
   public Growlithe(String name) {
      super("Growlithe", name, 58, FIRE_COLOR, 0.7, 19.0, 
           FIRE_TYPE, "", BASE_ATTACK_POWER, 
           BASE_DEFENSE_POWER, BASE_STAMINA_POWER);
         //pick Attacks
      chooseFastAttack();
      ...
      *@param typeTwo secondary type.
	   */
   protected Growlithe(String species, String name, int num, String fireColor,

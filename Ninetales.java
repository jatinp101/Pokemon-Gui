...
/**
 * Ninetales Pokemon Object Class.
 * Impliment FireType class.
 * @author Jatin P
 * @since 9/21/2018
 */
public class Ninetales extends Pokemon implements FireType {
	 /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 169;
	   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 190;
	   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 177;
	   ...
	   */
   public Ninetales() {
      super("Ninetales", "Ninetales", 38, FIRE_COLOR, 1.09, 9.91, 
   ...
   public Ninetales(String name) {
      super("Ninetales", name, 38, FIRE_COLOR, 1.09, 9.91, 
           FIRE_TYPE, "", BASE_ATTACK_POWER, 
           BASE_DEFENSE_POWER, BASE_STAMINA_POWER);
         //pick Attacks
      chooseFastAttack();
      ...
      *@param typeTwo secondary type.
	   */
   protected Ninetales(String species, String name, int num, String fireColor,

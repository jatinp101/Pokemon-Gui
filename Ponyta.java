...
public class Ponyta extends Pokemon implements FireType {
   ...
   static final int BASE_DEFENSE_POWER = 127;
   ...
   static final int BASE_STAMINA_POWER = 137;
	   ...
	   */
   public Ponyta() {
      super("Ponyta", "Ponyta", 77, FIRE_COLOR, 1.0, 30.0, 
   ...
   public Ponyta(String name) {
      super("Ponyta", name, 77, FIRE_COLOR, 1.0, 30.0, 
           FIRE_TYPE, "", BASE_ATTACK_POWER, 
           BASE_DEFENSE_POWER, BASE_STAMINA_POWER);
         //pick Attacks
      chooseFastAttack();
      ...
      *@param typeTwo secondary type.
	   */
   protected Ponyta(String species, String name, int num, String fireColor,

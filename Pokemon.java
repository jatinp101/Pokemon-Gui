...
public abstract class Pokemon implements Comparable<Pokemon> {        
  ...
  */
   public void setName(String newName) {
      ...
      if (newName.length() == 0) {
         PokemonException pe = new PokemonException("Name cannot be blank");
         throw pe;
      }
      else {
         this.name = newName;
   ...
   */  
   ...
   /**
    * Comparison.
    * @param o is the pokemon 
    * @return Integer of the comparison
    */
   public int compareTo(Pokemon o) {
      int c = -1;
      if (this.number == o.number && this.name == o.name
           && this.hP == o.hP && this.fastAttack == o.fastAttack
           && this.specialAttack == o.specialAttack) {
         c = 0;
         return c; 
      } else {
         ...
         else if (this.fastAttack != o.fastAttack) {
            string1 = this.fastAttack;
            string2 = o.fastAttack; 
            c = string1.compareTo(string2);
         }
         else if (this.specialAttack != o.specialAttack) {
            string1 = this.specialAttack;
            string2 = o.specialAttack; 
            c = string1.compareTo(string2);
         }
         return c;
      }
    ...
    /**
   * Push out boolean variable when comparing.
   * @return 1 | 0
   * @param p pokemon to compare
   */ 
   public boolean equals(Pokemon p) {
      return this.number == p.number && this.name == p.name 
            && this.hP == p.hP && this.cP == p.cP 
            && this.fastAttack == p.fastAttack 

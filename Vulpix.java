...
/**
 * Vulpix Pokemon Object Class.
 * Impliment FireType class.
 * @author Jatin P
 * @since 9/21/2018
 */
public class Vulpix extends Pokemon implements FireType {
	 /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 96;
	   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 109;
   ...
   static final int BASE_STAMINA_POWER = 116;
	   ...
	   */
   public Vulpix() {
      super("Vulpix", "Vulpix", 37, FIRE_COLOR, 0.61, 9.89, 
   ...
   public Vulpix(String name) {
      super("Vulpix", name, 37, FIRE_COLOR, 0.61, 9.89, 
           FIRE_TYPE, "", BASE_ATTACK_POWER, 
           BASE_DEFENSE_POWER, BASE_STAMINA_POWER);
         //pick Attacks
      chooseFastAttack();
      ...
      *@param typeTwo secondary type.
	   */
   protected Vulpix(String species, String name, int num, String fireColor,

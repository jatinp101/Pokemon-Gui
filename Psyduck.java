...
/**
 * Psyduck Pokemon object class.
 * Impliment water class.
 * @author Jatin P
 * @since 9/21/2018
 */
 // Template taken from Bulbasaur.java
public class Psyduck extends Pokemon implements WaterType {
	 /** The minimum attack power for species. */
   static final int BASE_ATTACK_POWER = 122;
	   /** The minimum defense power for species. */
   static final int BASE_DEFENSE_POWER = 95;
	   /** The minimum stamina power for species. */
   static final int BASE_STAMINA_POWER = 137;
	   ...
	   */
   public Psyduck() {
      super("Psyduck", "Psyduck", 57, WATER_COLOR, 0.79, 19.6, 
   ...
   public Psyduck(String name) {
      super("Psyduck", name, 7, WATER_COLOR, 0.79, 19.6, 
           WATER_TYPE, "", BASE_ATTACK_POWER, 
           BASE_DEFENSE_POWER, BASE_STAMINA_POWER);
         //pick Attacks
      chooseFastAttack();
	   ...
	   * This allows subclass specific name, number, height, weight,andbasePowers
	   ...
	   */
   protected Psyduck(String species, String name, int num, 
